...
$notifsql = "INSERT INTO notifications_tbl SET post_ID= '$postID', actor_ID = '$dislikerID', content = '$notifContent', action_type = 'like', poster_ID = '$poster_ID', active = 1, action_time='$date';";
